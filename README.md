...
# Try it out
You can test the application with your friends by downloading the release version here: [click here](https://github.com/Jazzcort/Rust_RealTime_Chat/releases/tag/v1.0.0). Or, you cna just git clone the source code and compile it on your own.